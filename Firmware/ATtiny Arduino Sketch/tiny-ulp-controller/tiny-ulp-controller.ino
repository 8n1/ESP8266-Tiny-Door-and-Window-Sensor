...
+  -> Jetzt wird gewartet bis vom ESP ein Signal über PB4 kommt dass den tiny veranlasst den Spannungsregler wieder abzuschalten,
...
+  -> Anschließend geht der ATTiny wieder in den Tiefschlaf(Power-down) und wartet auf den nächsten Interrupt.
+
**************************************************************************************************************/
